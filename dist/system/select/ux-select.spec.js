System.register(['test/setup', 'aurelia-testing', 'aurelia-bootstrapper', 'aurelia-pal', './ux-select'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var aurelia_testing_1, aurelia_bootstrapper_1, aurelia_pal_1, ux_select_1;
    var resources;
    function arrange(bindingContext, bind, attach, view) {
        return Promise
            .resolve(aurelia_testing_1.StageComponent
            .withResources(resources)
            .inView(view)
            .boundTo(bindingContext)
            .manuallyHandleLifecycle())
            .then(function (c) {
            return c.create(aurelia_bootstrapper_1.bootstrap).then(function () { return Promise.resolve(c); });
        })
            .then(function (c) {
            if (bind === true) {
    ...
    return {
        setters:[
            function (_1) {},
            function (aurelia_testing_1_1) {
                aurelia_testing_1 = aurelia_testing_1_1;
            },
            ...
            describe('ux-select', function () {
                describe('by default', function () {
                    ...
                    beforeEach(function () {
                        ...
                        dummyStyleEngine = {};
                        dummyBindingEngine = {};
                        sut = new ux_select_1.UxSelect(dummyElement, dummyResources, dummyStyleEngine, dummyBindingEngine);
                    });
                ...
                describe('created()', function () {
                    var sut;
                    beforeEach(function () {
                        sut = new ux_select_1.UxSelect(null, null, null, null);
                    });
                ...
                describe('bind()', function () {
                    ...
                    it('calls themeChanged()', function () {
                        var spy = spyOn(sut, 'themeChanged').and.callFake(aurelia_pal_1.PLATFORM.noop);
                        sut.bind();
                        expect(spy).toHaveBeenCalledWith(sut.theme);
                    });
                    it('calls optionsChanged()', function () {
                        var spy = spyOn(sut, 'optionsChanged').and.callFake(aurelia_pal_1.PLATFORM.noop);
                        sut.bind();
                        expect(spy).toHaveBeenCalledWith(sut.options);
                    });
                    it('calls valueChanged()', function () {
                        var spy = spyOn(sut, 'valueChanged').and.callFake(aurelia_pal_1.PLATFORM.noop);
                        sut.bind();
                ...
                describe('attached()', function () {
                    ...
                    var dummyElement;
                    beforeEach(function () {
                        dummyElement = aurelia_pal_1.DOM.createElement('div');
                        sut = new ux_select_1.UxSelect(dummyElement, null, null, null);
                    });
                ...
                describe('unbind()', function () {
                    ...
                    describe('when optionsCollectionSubscription is defined', function () {
                        ...
                        beforeEach(function () {
                            mockOptionsCollectionSubscription = { dispose: aurelia_pal_1.PLATFORM.noop };
                ...
                describe('themeChanged()', function () {
                    ...
                    var mockStyleEngine;
                    beforeEach(function () {
                        mockStyleEngine = { applyTheme: aurelia_pal_1.PLATFORM.noop };
                        sut = new ux_select_1.UxSelect(null, null, mockStyleEngine, null);
                    });
                ...
                describe('optionsChanged()', function () {
                    ...
                    beforeEach(function () {
                        ...
                        sut = new ux_select_1.UxSelect(null, null, null, fakeBindingEngine);
                    });
                    describe('when optionsCollectionSubscription is defined', function () {
                        beforeEach(function () {
                            sut.optionsCollectionSubscription = mockOptionsCollectionSubscription;
                    ...
                    describe('when a valid collection is passed in', function () {
                        ...
                        it('calls addOption for each item in the collection', function () {
                            var options = [1, 2, 3];
                            var spy = spyOn(sut, 'addOption').and.callFake(aurelia_pal_1.PLATFORM.noop);
